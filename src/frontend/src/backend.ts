...
export class Backend implements backendInterface {
    ...
    async checkResponse(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.checkResponse();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async submitResponse(arg0: Name, arg1: Response): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitResponse(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
